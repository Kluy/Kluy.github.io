!function(n){n.fn.fancybox=function(){function i(){a.hide(),o.hide(),e=!1}var a,o,c=this,t=n("body"),e=!1;return c.on("click",function(f){if(f.preventDefault(),!e){var r=(c=n(this)).attr("href");a=n('<div class="fancybox-modal"><img src="'+r+'"></div>'),o=n('<div class="fancybox-overlay"></div>'),f.stopPropagation(),t.append(o),t.append(a),o.one("click",i),e=!0}}),this}}(jQuery);
$(function(){wow=new WOW({boxClass:"wow",animateClass:"animated",offset:-10}),$(".owl-carousel").owlCarousel({loop:!0,margin:10,autoplay:!0,autoplayTimeout:4e3,mouseDrag:!1,responsive:{0:{items:1}}}),$(".about-us-gear").hover(function(){$(".about-us__ico-gear").addClass("gear")},function(){$(".about-us__ico-gear").removeClass("gear")}),$(".about-us-truck").hover(function(){$(".about-us__ico-truck").addClass("truck")},function(){$(".about-us__ico-truck").removeClass("truck")});var o=$(".banners__accordion  .accordion__text").hide();$(".accordion__block").click(function(){if(!$(this).hasClass("accordion__block--active"))return o.not($(this).next()).slideUp(300),$(".accordion__block").children(".opener").html("+").removeClass("accordion__block--active"),$(this).children(".opener").html("-"),$(this).addClass("accordion__block--active"),$(this).next().slideDown(300),!1;$(this).next().slideUp(300),$(this).children(".opener").html("+"),$(this).removeClass("accordion__block--active")})});
